...
class barReadyScreen extends StatefulWidget {
  const barReadyScreen({Key? key}) : super(key: key);

  @override
  State<barReadyScreen> createState() => barReadyPage();
}

class barReadyPage extends State<barReadyScreen> {
  double buttonOpac = 0;
